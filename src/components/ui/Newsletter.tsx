  ...
  return (
    <div>
      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-2">
        ...
        <button
          type="submit"
          className="newsletter-button relative w-full overflow-hidden rounded-md bg-lochinvar-600 px-4 py-2 text-sm font-medium text-white dark:bg-lochinvar-500"
        >
